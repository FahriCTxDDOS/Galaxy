...
if ipf == "":
   ipf = "45.67.231"
os.system("clear")
os.system("figlet Welcome | lolcat -a -d 5  ")
time.sleep(2)
os.system("clear")
def retun():
	os.system("clear")
	...
	print("\033[1;34;40m     ╚═╝ ╩ ╩ ╝╚╝ ╝╚╝ ╚═╝ ╝╚╝ ")
	print("╔═══════════════════╗  ╔══════════════════╗")
	print("║ BETA 1.1.1        ║  ║ Galaxy Cannon    ║ ")
	print("║ Metod : WEB       ║  ║ Made By FahriCT  ║  ")
	print("╚═══════════════════╝  ╚══════════════════╝")
	print("            ╔══════════════════╗")
	print("            ║ IN TO SEE INFO   ║ ")
	print("            ║ ST TO START      ║  ")
	print("            ╚══════════════════╝")
	mn = input("Pilih : ")
	if mn == "IN" :
		print("===Nama Kamu Adalah==== ")
		print(yf)
		print("===Fake Ip Mu adalah====")
		print(ipf)
